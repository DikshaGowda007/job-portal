...
use App\Repositories\MySql\V1\JobAlertRepositoryImpl;
...
use App\Repositories\MySql\V1\ShortlistedCandidateRepositoryImpl;
...
class RepositoryServiceProvider extends ServiceProvider
{
    ...
    public function register(): void
    {
        ...
        $this->app->bind(ShortlistedCandidateRepository::class, ShortlistedCandidateRepositoryImpl::class);
        $this->app->bind(JobAlertRepository::class, JobAlertRepositoryImpl::class);
