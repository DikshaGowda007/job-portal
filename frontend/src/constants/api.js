...
export const API = {
  ...
  JOB: {
    ...
    ANALYZE: `${BASE_URL}/api/v1/job/analyze`,
  },
  ...
  RECRUITER: {
    ...
    SHORTLIST_ADD: `${BASE_URL}/api/v1/recruiter/candidates/shortlist/add`,
    SHORTLIST_LIST: `${BASE_URL}/api/v1/recruiter/candidates/shortlist/list`,
    SHORTLIST_DELETE: `${BASE_URL}/api/v1/recruiter/candidates/shortlist/delete`,
