...
export default function PublicJobCard({ job }) {
  return (
    <Link
      to={ROUTES.PUBLIC_JOB_DETAIL.replace(":id", job.job_id)}
      className="block rounded-2xl border border-gray-200 bg-white p-5 shadow-sm transition hover:border-indigo-300 hover:shadow-md dark:border-gray-800 dark:bg-gray-900 dark:hover:border-indigo-700"
    >
