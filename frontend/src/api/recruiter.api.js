...
export const recruiterApi = {
  ...
  getShortlistedCandidates: (params) => axiosClient.post(API.RECRUITER.SHORTLIST_LIST, params),
  shortlistCandidate: (payload) => axiosClient.post(API.RECRUITER.SHORTLIST_ADD, payload),
  unshortlistCandidate: (payload) => axiosClient.post(API.RECRUITER.SHORTLIST_DELETE, payload),
